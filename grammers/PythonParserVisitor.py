...
class PythonParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by PythonParser#ElementListExpr.
    def visitElementListExpr(self, ctx:PythonParser.ElementListExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by PythonParser#KeyValuePairExpr.
    def visitKeyValuePairExpr(self, ctx:PythonParser.KeyValuePairExprContext):
        return self.visitChildren(ctx)
